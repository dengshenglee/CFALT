...
//       IfStmtNode      "epilogue_" + myId.name()    ExpNode, DeclListNode, StmtListNode
...
//       AssignNode          ExpNode, ExpNode"epilogue_" + myId.name()
...
class FormalsListNode extends ASTnode {
    ...
    public List<Type> nameAnalysis(SymTable symTab) {
        ...
        symTab.formalSize = myFormals.size();
            ...
            try {
                if (myType instanceof StructNode) {
                    ...
                    if(globalTab.size() > 1){
                        sym.setGlobal(false);
                        globalTab.offset += 4;
                        sym.setOffset(globalTab.offset);
                    }else{
                        sym.setGlobal(true);
                    }
                }
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen(){
        ...
        if(myId.name().equals("main")){
            ...
            Codegen.generate("subu", Codegen.SP, Codegen.SP, offset);
            ...
            //epilogue
            Codegen.generateLabeled("epilogue_" + myId.name());
    ...
    public Sym nameAnalysis(SymTable symTab) {
        ...
        myId.sym().setOffset(myBody.getLocalsNum()*4);
    ...
    public Sym nameAnalysis(SymTable symTab) {
        ...
        if (!badDecl) {  // insert into symbol table
            try {
                sym = new Sym(myType.type());
                sym.setGlobal(false);
                //TODO set the parameters offset, which can be positive coz it is under the fp
                if(symTab.formalSize > 0){
                    sym.setOffset(-4*(symTab.formalSize));
                    symTab.formalSize--;
...
class PostDecStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        ((IdNode)myExp).genAddr();
        Codegen.genPop(Codegen.T1);
        Codegen.generate("subu", Codegen.T1, Codegen.T1, "1");
        Codegen.generateIndexed("sw", Codegen.T1, Codegen.T0, 0);
    }
...
class IfStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        myExp.codeGen();
        Codegen.genPop(Codegen.T0);
        Codegen.generate("beq", Codegen.T0,"0", jump_label);
        myDeclList.codeGen();
        myStmtList.codeGen();
...
class WhileStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        Codegen.genPop(Codegen.T0);
        Codegen.generate("li", Codegen.T1, "0");
        Codegen.generate("beq", Codegen.T0, Codegen.T1, endLabel);
        myStmtList.codeGen();
...
class ReturnStmtNode extends StmtNode {
    ...
    public void codeGen(){
        ...
        Codegen.generate("j","epilogue_"+currentFunction);
...
class EqualsNode extends EqualityExpNode {
    ...
    public void codeGen(){
        if(myExp1 instanceof StringLitNode && myExp2 instanceof StringLitNode){
            ...
            String str2 = ((StringLitNode)myExp1).toString();
            Codegen.generate("li", Codegen.T0, str1.equals(str2)?"1":"0");
            Codegen.genPush(Codegen.T0);
        }else{
            myExp1.codeGen();
            myExp2.codeGen();
...
class NotEqualsNode extends EqualityExpNode {
    ...
    public void codeGen(){
        if(myExp1 instanceof StringLitNode && myExp2 instanceof StringLitNode){
            String str1  =((StringLitNode)myExp1).toString();
            String str2 = ((StringLitNode)myExp1).toString();
            Codegen.generate("li", Codegen.T0, str1.equals(str2)?"0":"1");
            Codegen.genPush(Codegen.T0);
        }else{
            myExp1.codeGen();
            myExp2.codeGen();
